...
static int __pyx_f_4CyLP_2cy_26CyClpPrimalColumnPivotBase_26CyClpPrimalColumnPivotBase_DantzigDualUpdate(struct __pyx_obj_4CyLP_2cy_26CyClpPrimalColumnPivotBase_CyClpPrimalColumnPivotBase *__pyx_v_self, ICoinIndexedVector *__pyx_v_updates, ICoinIndexedVector *__pyx_v_spareRow1, ICoinIndexedVector *__pyx_v_spareRow2, ICoinIndexedVector *__pyx_v_spareColumn1, ICoinIndexedVector *__pyx_v_spareColumn2) {
  ...
  __Pyx_RefNannyDeclarations
  __Pyx_TraceDeclarations
  __Pyx_RefNannySetupContext("DantzigDualUpdate", 0);
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(__pyx_v_self->CppSelf->model()->getNumRows()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyInt_FromLong(__pyx_v_self->CppSelf->model()->getNumCols()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("CyClpPrimalColumnPivotBase"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
