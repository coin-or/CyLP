/* Generated by Cython 0.15.1 on Sat Oct 20 16:23:48 2012 */
...
static int __pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
 ...
 */
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf = new CoinModel();
...
static void __pyx_f_4CyLP_2cy_11CyCoinModel_11CyCoinModel_CLP_addColumn(struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *__pyx_v_self, int __pyx_v_numberInColumn, int *__pyx_v_rows, double *__pyx_v_elements, double __pyx_v_columnLower, double __pyx_v_columnUpper, double __pyx_v_objectiveValue) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("CLP_addColumn");

  /* "CyLP/cy/CyCoinModel.pyx":64
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_1addVariable(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_1addVariable[] = "CyCoinModel.addVariable(self, numberInColumn, ndarray rows, ndarray elements, columnLower, columnUpper, objective)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_1addVariable(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("addVariable");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "addVariable") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_elements), __pyx_ptype_5numpy_ndarray, 1, "elements", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_rows, (PyObject*)__pyx_v_rows, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_rows = __pyx_bstruct_rows.strides[0];
  __pyx_bshape_0_rows = __pyx_bstruct_rows.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_elements, (PyObject*)__pyx_v_elements, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 85; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_numberInColumn); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 91; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  ((struct __pyx_vtabstruct_4CyLP_2cy_11CyCoinModel_CyCoinModel *)((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->__pyx_vtab)->CLP_addColumn(((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self), __pyx_t_1, ((int *)__pyx_v_rows->data), ((double *)__pyx_v_elements->data), __pyx_t_2, __pyx_t_3, __pyx_t_4);
...
static void __pyx_f_4CyLP_2cy_11CyCoinModel_11CyCoinModel_CLP_addRow(struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *__pyx_v_self, int __pyx_v_numberInRow, int *__pyx_v_columns, double *__pyx_v_elements, double __pyx_v_rowLower, double __pyx_v_rowUpper) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("CLP_addRow");
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_2addConstraint(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_2addConstraint[] = "CyCoinModel.addConstraint(self, numberInRow, ndarray columns, ndarray elements, rowLower, rowUpper)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_2addConstraint(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("addConstraint");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "addConstraint") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_columns, (PyObject*)__pyx_v_columns, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_columns = __pyx_bstruct_columns.strides[0];
  __pyx_bshape_0_columns = __pyx_bstruct_columns.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_elements, (PyObject*)__pyx_v_elements, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 115; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_elements = __pyx_bstruct_elements.strides[0];
  __pyx_bshape_0_elements = __pyx_bstruct_elements.shape[0];
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_numberInRow); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 120; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  ((struct __pyx_vtabstruct_4CyLP_2cy_11CyCoinModel_CyCoinModel *)((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->__pyx_vtab)->CLP_addRow(((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self), __pyx_t_1, ((int *)__pyx_v_columns->data), ((double *)__pyx_v_elements->data), __pyx_t_2, __pyx_t_3);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_3setVariableLower(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_3setVariableLower[] = "CyCoinModel.setVariableLower(self, ind, val)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_3setVariableLower(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("setVariableLower");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setVariableLower") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 123; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_ind); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 124; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->setColumnLower(__pyx_t_1, __pyx_t_2);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_4setVariableUpper(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_4setVariableUpper[] = "CyCoinModel.setVariableUpper(self, ind, val)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_4setVariableUpper(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_ind = 0;
  PyObject *__pyx_v_val = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__ind,&__pyx_n_s__val,0};
  __Pyx_RefNannySetupContext("setVariableUpper");
  {
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setVariableUpper") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 126; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_ind); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 127; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->setColumnUpper(__pyx_t_1, __pyx_t_2);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_5setConstraintLower(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_5setConstraintLower[] = "CyCoinModel.setConstraintLower(self, ind, val)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_5setConstraintLower(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_ind = 0;
  PyObject *__pyx_v_val = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__ind,&__pyx_n_s__val,0};
  __Pyx_RefNannySetupContext("setConstraintLower");
  {
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setConstraintLower") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_ind); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 130; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->setRowLower(__pyx_t_1, __pyx_t_2);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_6setConstraintUpper(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_6setConstraintUpper[] = "CyCoinModel.setConstraintUpper(self, ind, val)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_6setConstraintUpper(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_ind = 0;
  PyObject *__pyx_v_val = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__ind,&__pyx_n_s__val,0};
  __Pyx_RefNannySetupContext("setConstraintUpper");
  {
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setConstraintUpper") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 132; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_ind); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->setRowUpper(__pyx_t_1, __pyx_t_2);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_7setObjective(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_7setObjective[] = "CyCoinModel.setObjective(self, varInd, val)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_7setObjective(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__varInd,&__pyx_n_s__val,0};
  __Pyx_RefNannySetupContext("setObjective");
  {
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "setObjective") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 135; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
 ...
 */
  __pyx_t_1 = __Pyx_PyInt_AsInt(__pyx_v_varInd); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 136; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  ((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->setObjective(__pyx_t_1, __pyx_t_2);
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_8getNumVariables(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_8getNumVariables[] = "CyCoinModel.getNumVariables(self)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_8getNumVariables(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNumVariables");
 ...
 */
  ...
  __pyx_t_1 = PyInt_FromLong(((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->numberColumns()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 139; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_9getNumConstraints(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static char __pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_9getNumConstraints[] = "CyCoinModel.getNumConstraints(self)";
static PyObject *__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_9getNumConstraints(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNumConstraints");
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = PyInt_FromLong(((struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel *)__pyx_v_self)->CppSelf->numberRows()); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_tp_new_4CyLP_2cy_11CyCoinModel_CyCoinModel(PyTypeObject *t, PyObject *a, PyObject *k) {
  ...
  if (__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel___cinit__(o, __pyx_empty_tuple, NULL) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}
...
static PyMethodDef __pyx_methods_4CyLP_2cy_11CyCoinModel_CyCoinModel[] = {
  {__Pyx_NAMESTR("addVariable"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_1addVariable, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_1addVariable)},
  {__Pyx_NAMESTR("addConstraint"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_2addConstraint, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_2addConstraint)},
  {__Pyx_NAMESTR("setVariableLower"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_3setVariableLower, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_3setVariableLower)},
  {__Pyx_NAMESTR("setVariableUpper"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_4setVariableUpper, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_4setVariableUpper)},
  {__Pyx_NAMESTR("setConstraintLower"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_5setConstraintLower, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_5setConstraintLower)},
  {__Pyx_NAMESTR("setConstraintUpper"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_6setConstraintUpper, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_6setConstraintUpper)},
  {__Pyx_NAMESTR("setObjective"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_7setObjective, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_7setObjective)},
  {__Pyx_NAMESTR("getNumVariables"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_8getNumVariables, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_8getNumVariables)},
  {__Pyx_NAMESTR("getNumConstraints"), (PyCFunction)__pyx_pf_4CyLP_2cy_11CyCoinModel_11CyCoinModel_9getNumConstraints, METH_NOARGS, __Pyx_DOCSTR(__pyx_doc_4CyLP_2cy_11CyCoinModel_11CyCoinModel_9getNumConstraints)},
  {0, 0, 0, 0}
};

static PyNumberMethods __pyx_tp_as_number_CyCoinModel = {
  0, /*nb_add*/
  0, /*nb_subtract*/
  0, /*nb_multiply*/
  #if PY_MAJOR_VERSION < 3
...
static PySequenceMethods __pyx_tp_as_sequence_CyCoinModel = {
  0, /*sq_length*/
  0, /*sq_concat*/
  0, /*sq_repeat*/
  0, /*sq_item*/
...
static PyMappingMethods __pyx_tp_as_mapping_CyCoinModel = {
  0, /*mp_length*/
  0, /*mp_subscript*/
  0, /*mp_ass_subscript*/
};

static PyBufferProcs __pyx_tp_as_buffer_CyCoinModel = {
  #if PY_MAJOR_VERSION < 3
  0, /*bf_getreadbuffer*/
  #endif
  #if PY_MAJOR_VERSION < 3
...
static PyTypeObject __pyx_type_4CyLP_2cy_11CyCoinModel_CyCoinModel = {
  ...
  __Pyx_NAMESTR("CyLP.cy.CyCoinModel.CyCoinModel"), /*tp_name*/
  ...
  #endif
  0, /*tp_repr*/
  &__pyx_tp_as_number_CyCoinModel, /*tp_as_number*/
  &__pyx_tp_as_sequence_CyCoinModel, /*tp_as_sequence*/
  &__pyx_tp_as_mapping_CyCoinModel, /*tp_as_mapping*/
  0, /*tp_hash*/
  0, /*tp_call*/
  0, /*tp_str*/
  0, /*tp_getattro*/
  0, /*tp_setattro*/
  &__pyx_tp_as_buffer_CyCoinModel, /*tp_as_buffer*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_CyCoinModel(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("CyCoinModel"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__Pyx_SetAttrString(__pyx_m, "CyCoinModel", (PyObject *)&__pyx_type_4CyLP_2cy_11CyCoinModel_CyCoinModel) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
