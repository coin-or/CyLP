...
#endif
{
  ...
  __pyx_ptype_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot = __Pyx_ImportType("CyLP.cy.CyDantzigPivot", "CyDantzigPivot", sizeof(struct __pyx_obj_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot)) {__pyx_filename = __pyx_f[13]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot = (struct __pyx_vtabstruct_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_14CyDantzigPivot_CyDantzigPivot)) {__pyx_filename = __pyx_f[13]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_9CyPEPivot_CyPEPivot = __Pyx_ImportType("CyLP.cy.CyPEPivot", "CyPEPivot", sizeof(struct __pyx_obj_4CyLP_2cy_9CyPEPivot_CyPEPivot), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_9CyPEPivot_CyPEPivot)) {__pyx_filename = __pyx_f[14]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_9CyPEPivot_CyPEPivot = (struct __pyx_vtabstruct_4CyLP_2cy_9CyPEPivot_CyPEPivot*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_9CyPEPivot_CyPEPivot->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_9CyPEPivot_CyPEPivot)) {__pyx_filename = __pyx_f[14]; __pyx_lineno = 6; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
