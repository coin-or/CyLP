...
static int __pyx_pw_4CyLP_2cy_17CyPivotPythonBase_17CyPivotPythonBase_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__pivotMethodObject)) != 0)) kw_args--;
...
static void __pyx_f_4CyLP_2cy_17CyPivotPythonBase_17CyPivotPythonBase_saveWeights(struct __pyx_obj_4CyLP_2cy_17CyPivotPythonBase_CyPivotPythonBase *__pyx_v_self, IClpSimplex *__pyx_v_model, CYTHON_UNUSED int __pyx_v_mode) {
  __Pyx_RefNannyDeclarations
...
#endif
{
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("CyPivotPythonBase"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
