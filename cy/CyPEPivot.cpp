/* Generated by Cython 0.17.4 on Mon Apr  1 00:33:13 2013 */
...
#endif
{
  ...
  __pyx_ptype_4CyLP_2cy_11CyCoinModel_CyCoinModel = __Pyx_ImportType("CyLP.cy.CyCoinModel", "CyCoinModel", sizeof(struct __pyx_obj_4CyLP_2cy_11CyCoinModel_CyCoinModel), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_11CyCoinModel_CyCoinModel)) {__pyx_filename = __pyx_f[3]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_11CyCoinModel_CyCoinModel = (struct __pyx_vtabstruct_4CyLP_2cy_11CyCoinModel_CyCoinModel*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_11CyCoinModel_CyCoinModel->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_11CyCoinModel_CyCoinModel)) {__pyx_filename = __pyx_f[3]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel = __Pyx_ImportType("CyLP.cy.CyCbcModel", "CyCbcModel", sizeof(struct __pyx_obj_4CyLP_2cy_10CyCbcModel_CyCbcModel), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel)) {__pyx_filename = __pyx_f[7]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_10CyCbcModel_CyCbcModel = (struct __pyx_vtabstruct_4CyLP_2cy_10CyCbcModel_CyCbcModel*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_10CyCbcModel_CyCbcModel)) {__pyx_filename = __pyx_f[7]; __pyx_lineno = 55; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_vtabptr_4CyLP_2cy_19CyCoinIndexedVector_CyCoinIndexedVector = (struct __pyx_vtabstruct_4CyLP_2cy_19CyCoinIndexedVector_CyCoinIndexedVector*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_19CyCoinIndexedVector_CyCoinIndexedVector->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_19CyCoinIndexedVector_CyCoinIndexedVector)) {__pyx_filename = __pyx_f[8]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_12CyClpSimplex_CyClpSimplex = __Pyx_ImportType("CyLP.cy.CyClpSimplex", "CyClpSimplex", sizeof(struct __pyx_obj_4CyLP_2cy_12CyClpSimplex_CyClpSimplex), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_12CyClpSimplex_CyClpSimplex)) {__pyx_filename = __pyx_f[9]; __pyx_lineno = 234; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus = __Pyx_ImportType("CyLP.cy.CyClpSimplex", "VarStatus", sizeof(struct __pyx_obj_4CyLP_2cy_12CyClpSimplex_VarStatus), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus)) {__pyx_filename = __pyx_f[9]; __pyx_lineno = 306; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
