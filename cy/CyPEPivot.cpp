...
#endif
{
  ...
  __pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel = __Pyx_ImportType("CyLP.cy.CyCbcModel", "CyCbcModel", sizeof(struct __pyx_obj_4CyLP_2cy_10CyCbcModel_CyCbcModel), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel)) {__pyx_filename = __pyx_f[11]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus = __Pyx_ImportType("CyLP.cy.CyClpSimplex", "VarStatus", sizeof(struct __pyx_obj_4CyLP_2cy_12CyClpSimplex_VarStatus), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus)) {__pyx_filename = __pyx_f[12]; __pyx_lineno = 331; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
