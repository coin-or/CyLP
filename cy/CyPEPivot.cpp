/* Generated by Cython 0.15.1 on Wed Mar  7 17:49:41 2012 */
...
#endif
{
  ...
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglCutGenerator = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglCutGenerator", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglCutGenerator), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglCutGenerator)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 41; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglProbing = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglProbing", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglProbing), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglProbing)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglGomory", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglGomory), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglGomory = (struct __pyx_vtabstruct_4CyLP_2cy_5CyCgl_CyCglGomory*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglGomory)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 48; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglClique = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglClique", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglClique), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglClique)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglFlowCover = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglFlowCover", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglFlowCover), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglFlowCover)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 57; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_5CyCgl_CglRedSplit = __Pyx_ImportType("CyLP.cy.CyCgl", "CglRedSplit", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CglRedSplit), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CglRedSplit)) {__pyx_filename = __pyx_f[4]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel = __Pyx_ImportType("CyLP.cy.CyCbcModel", "CyCbcModel", sizeof(struct __pyx_obj_4CyLP_2cy_10CyCbcModel_CyCbcModel), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_10CyCbcModel_CyCbcModel)) {__pyx_filename = __pyx_f[6]; __pyx_lineno = 44; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus = __Pyx_ImportType("CyLP.cy.CyClpSimplex", "VarStatus", sizeof(struct __pyx_obj_4CyLP_2cy_12CyClpSimplex_VarStatus), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_12CyClpSimplex_VarStatus)) {__pyx_filename = __pyx_f[8]; __pyx_lineno = 268; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
