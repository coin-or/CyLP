/* Generated by Cython 0.15.1 on Sat Oct 20 16:24:09 2012 */
...
#endif
{
  ...
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglCutGenerator = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglCutGenerator", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglCutGenerator), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglCutGenerator)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 42; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglProbing = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglProbing", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglProbing), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglProbing)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglGomory", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglGomory), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglGomory = (struct __pyx_vtabstruct_4CyLP_2cy_5CyCgl_CyCglGomory*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglGomory->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglGomory)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 49; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglClique = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglClique", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglClique), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglClique)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 54; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglFlowCover = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglFlowCover", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglFlowCover), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglFlowCover)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglKnapsackCover = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglKnapsackCover", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglKnapsackCover), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglKnapsackCover)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglKnapsackCover = (struct __pyx_vtabstruct_4CyLP_2cy_5CyCgl_CyCglKnapsackCover*)__Pyx_GetVtable(__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglKnapsackCover->tp_dict); if (unlikely(!__pyx_vtabptr_4CyLP_2cy_5CyCgl_CyCglKnapsackCover)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 62; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_ptype_4CyLP_2cy_5CyCgl_CyCglRedSplit = __Pyx_ImportType("CyLP.cy.CyCgl", "CyCglRedSplit", sizeof(struct __pyx_obj_4CyLP_2cy_5CyCgl_CyCglRedSplit), 1); if (unlikely(!__pyx_ptype_4CyLP_2cy_5CyCgl_CyCglRedSplit)) {__pyx_filename = __pyx_f[2]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
